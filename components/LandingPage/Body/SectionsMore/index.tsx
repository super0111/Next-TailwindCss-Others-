  ...
  return (
    <div className="absolute top-0 left-0 right-0 -mt-52">
      <div className="max-w-screen-xl overflow-x-auto lg:overflow-visible p-8 mx-auto">
        <div className="hidden lg:grid grid-cols-3 gap-10 gap-0 divide-x bg-white py-16 rounded-2xl" style={{boxShadow:"0px 24px 100px -8px rgba(255, 181, 205, 0.4)"}}>
