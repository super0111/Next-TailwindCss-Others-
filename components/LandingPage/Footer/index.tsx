...
const Footer = () => {
  return (
    <div className="px-4 py-14 sm:px-8 max-w-screen-xl mx-auto">
          ...
          <div className="space-y-4 col-span-1 lg:col-span-1">
            ...
            </div>
            {
              companies.map((item, i)=>(
                <a className="block text-base text-[#667085] hover:text-gray-400" href="#" key={i}>
                  {item.text}
                </a>
              ))
            }
        ...
        <div className="max-w-[450px]">
          <div className="pb-12 space-y-4">
            ...
            <div className="text-gray-500">
              Stay informed with updates about Toucan and the ReFi ecosystem. No spam,
              scout&apos;s honour! 🌳
            </div>
            <form>
              <fieldset className="flex">
                <input 
                  type="text"
                  className="border border-gray-300 placeholder:text-gray-500 rounded-l-lg shadow-xs focus:outline-none w-full px-4 py-3 truncate"
                  placeholder="Enter email address"
                />
                <button 
                  type="submit"
                  className="btn-bg-dark text-white whitespace-nowrap cursor-pointer hover:opacity-75 inline-flex items-center font-semibold shadow-sm rounded-r-lg px-5 py-3"
                >
                  Sign up  
                </button>
              </fieldset>
            ...
            <div className="text-xs text-gray-400">
              We’ll protect your data. Here’s our 
              <a className="text-xs text-gray-400 hover:text-[#667085]" href="#">
                Privacy Policy
              </a>
              .
            </div>
      ...
      <div className="pt-12 space-y-8 sm:space-y-0 sm:flex items-center justify-between">
        <div className="flex items-start justify-center sm:justify-end space-x-12 sm:space-x-8">
          { socialIcons.map((item, i)=>(
            <a href="#" className="text-gray-500 hover:text-gray-400" key={i}>
              {item.icon}
            </a>
          )) }
        </div>
        <div className="order-first flex items-center justify-center space-x-4">
          ...
          <div className='lg:mt-2 text-xs text-gray-400'>
            © Copyright 2022 Toucan Protocol.
          </div>
        </div>
      </div>
    </div>
